...
module.exports.config = {
 ...
 module.exports.onStart = async ({ event, args, api }) => {
   ...
   try {
    ...
    try {
      const url = `${await baseApiUrl()}/api/gen?prompt=${encodeURIComponent(prompt)}&model=flux&seed=${seed}`;
      ...
      attachment: fs.createReadStream(filePath),}, event.threadID, event.messageID
      );
